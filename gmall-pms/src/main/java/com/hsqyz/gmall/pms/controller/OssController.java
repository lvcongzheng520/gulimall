...
public class OssController {
    ...
    public ResponseVo<Object> policy(){
        String accessId = "LTAI5t9SxJ8v8HuB1fbf4Hok"; // 请填写您的AccessKeyId。
        String accessKey = "uBC2k4uL6IOyUzqyP9fDpqpy7fNuOj"; // 请填写您的AccessKeySecret。
        ...
        return ResponseVo.fail("服务器内部错误！");
    }
}
